   ...
   namespace details
   {
      ...
      namespace numeric
      {
         namespace details
         {
            ...
            template <typename T> inline T   d2g_impl(const T& v, mpfrreal_type_tag) { return (v  * mpfr::mpreal(10.0/9.0)); }
            template <typename T> inline T   g2d_impl(const T& v, mpfrreal_type_tag) { return (v  * mpfr::mpreal(9.0/10.0)); }
